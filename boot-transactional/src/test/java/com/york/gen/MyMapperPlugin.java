...
public class MyMapperPlugin extends FalseMethodPlugin {
    ...
    private boolean needsSwagger = true;
    ...
    private void processEntityClass(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        fields.forEach(f -> {
            if(f.getAnnotations().contains("@Id")){
                f.getAnnotations().add("@GeneratedValue(strategy=GenerationType.IDENTITY, generator = \"JDBC\")");
            }
        });
